...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="all_items">all kind itmes</option>
         <option value="daily_usage">daily needs</option>
      </select>
      ...
      <input type="file" name="image" class="box" accept="image/jpg, image/jpeg, image/png" height="300" width="227">
      <div class="flex-btn">
